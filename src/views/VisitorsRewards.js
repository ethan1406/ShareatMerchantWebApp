...
const VisitorsRewards = () => {
  ...
  const getMerchant = async () => {
    ...
    setFormData({ ...formData, ...data, tabValue: "day" });
  };
  useEffect(() => {
    getMerchant();
    VisitorsData();
  ...
  const VisitorsData = () => {
    var tabValue = formData.tabValue;
  ...
  return (
    <div>
      ...
      <section className="offer-section py-5">
        <Offers tabValue={formData.tabValue} />
      </section>
    </div>
  );
};
